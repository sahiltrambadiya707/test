...
module.exports = exports = async (req, res, next) => {
  ...
  const headers = {
    ...
    [enums.HEADER_PARAMS.CF_CONNECTING_IP]: req.header(
      enums.HEADER_PARAMS.CF_CONNECTING_IP
    ),
    [enums.HEADER_PARAMS.CF_IP_COUNTRY]: req.header(
      enums.HEADER_PARAMS.CF_IP_COUNTRY
    ),
